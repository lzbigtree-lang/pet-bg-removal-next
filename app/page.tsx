  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 to-purple-900 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-2xl w-full">
        ...
        {file && (
          <p className="text-center text-sm text-purple-600 mt-2">✅ {file.name}</p>
        )}
        ...
        {result && (
          <div className="mt-8 text-center">
            ...
            <a
              href={result}
              download="pet_no_bg.png"
              className="inline-block px-8 py-3 bg-green-500 text-white font-semibold rounded-2xl hover:bg-green-600 transition-all"
            >
              ⬇️ Download PNG
            </a>
          </div>
